  ...
  return (
    <div className="shell">
      ...
      <div className="scroll-area" ref={scrollAreaRef}>
        ...
        {page === "report"   && <ReportPage   records={records} fields={fields} isAdmin={isAdmin} currentShift={userLoginShift || getCurrentShift()} user={user} refTable={refTable} refColMap={refColMap} onRefTableSave={handleRefTableSave} onRefTableClear={handleRefTableClear} toast={toast} />}
